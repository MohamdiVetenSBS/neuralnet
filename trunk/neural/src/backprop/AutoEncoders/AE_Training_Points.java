...
public class AE_Training_Points extends Applet implements Runnable {
...
//        System.exit(0);
    ...
    public void run(){
        ...
        check_classification(AE_Training_Points.Set.TRAIN, false);
        check_classification(AE_Training_Points.Set.TEST, false);
        check_classification(AE_Training_Points.Set.BAD, false);
    }
    ...
    private static void check_classification(AE_Training_Points.Set set, boolean print_patterns){
        int set_size=0;
        String set_name="";
